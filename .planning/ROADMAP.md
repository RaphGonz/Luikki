...
- [x] 01-06-PLAN.md — Web contracts, per-request Store, upload choke point, app factory, `comiccolor serve`
...
- [x] 02-03-PLAN.md — ProtectedMask moves to page scope with polygon and touched (D-20); panel/protected store CRUD
...
- [x] 02-11-PLAN.md — Stage gate confirm and Go-Back routes with server-computed cost sentences
- [x] 02-12-PLAN.md — Frontend API client, DTO types, and the `#/page/{id}/edit` route
